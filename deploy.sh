...
docker run -it --rm terminusdb/terminus_store_prolog:latest bash -c "echo 'pack_install(''https://github.com/terminusdb/terminus_store_prolog/archive/${TRAVIS_TAG}.zip'', [interactive=false]).' | swipl"
