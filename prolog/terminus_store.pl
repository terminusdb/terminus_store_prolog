...
test(add_csv,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        ...
        "terminusdb:///data/csv"-"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"-node("csv:///schema#Csv"),
...
test(csv_prefixes,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        ...
        "that/csv"-"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"-node("csv:///schema#Csv"),
