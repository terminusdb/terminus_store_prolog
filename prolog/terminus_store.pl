...
test(add_csv,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        X-"csv:///schema#column_header"-value("\"2\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        X-"csv:///schema#column_some"-value("\"1\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        X-"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"-node(Row1),
        Y-"csv:///schema#column_header"-value("\"4\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        Y-"csv:///schema#column_some"-value("\"3\"^^'http://www.w3.org/2001/XMLSchema#string'"),
...
test(add_csv_skip_header,[cleanup(clean), setup(createng)]) :-
    ...
    findall(X-P-Y, triple(Layer, X, P, Y), Triples),
    Triples = [
        Row1-"csv:///schema#column_0"-value("\"1\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        Row1-"csv:///schema#column_1"-value("\"2\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        Row1-"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"-node(Row_Type),
        Row2-"csv:///schema#column_0"-value("\"3\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        Row2-"csv:///schema#column_1"-value("\"4\"^^'http://www.w3.org/2001/XMLSchema#string'"),
...
test(csv_prefixes,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        ...
        Row1-"this#column_header"-value("\"2\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        Row1-"this#column_some"-value("\"1\"^^'http://www.w3.org/2001/XMLSchema#string'"),
