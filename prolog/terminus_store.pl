...
test(add_csv,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        ...
        "csv:///data/csv"-"csv:///schema#column"-node("csv:///data/ColumnObject_csv_header"),
        "csv:///data/csv"-"csv:///schema#column"-node("csv:///data/ColumnObject_csv_some"),
        ...
        "csv:///data/csv"-"http://www.w3.org/2000/01/rdf-schema#label"-value("\"csv\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "csv:///data/row7b52009b64fd0a2a49e6d8a939753077792b0554"-"csv:///schema#column_header"-value("\"2\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "csv:///data/row7b52009b64fd0a2a49e6d8a939753077792b0554"-"csv:///schema#column_some"-value("\"1\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        ...
        "csv:///data/rowf1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59"-"csv:///schema#column_header"-value("\"4\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "csv:///data/rowf1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59"-"csv:///schema#column_some"-value("\"3\"^^'http://www.w3.org/2001/XMLSchema#string'"),
...
test(add_csv_skip_header,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        ...
        "csv:///data/csv"-"csv:///schema#column"-node("csv:///data/ColumnObject_csv_0"),
        "csv:///data/csv"-"csv:///schema#column"-node("csv:///data/ColumnObject_csv_1"),
        "csv:///data/csv"-"csv:///schema#row"-node("csv:///data/row7b52009b64fd0a2a49e6d8a939753077792b0554"),
        "csv:///data/csv"-"csv:///schema#row"-node("csv:///data/rowf1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59"),
        "csv:///data/csv"-"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"-node("csv:///schema#Csv"),
        "csv:///data/csv"-"http://www.w3.org/2000/01/rdf-schema#label"-value("\"csv\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "csv:///data/row7b52009b64fd0a2a49e6d8a939753077792b0554"-"csv:///schema#column_0"-value("\"1\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "csv:///data/row7b52009b64fd0a2a49e6d8a939753077792b0554"-"csv:///schema#column_1"-value("\"2\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        ...
        "csv:///data/rowf1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59"-"csv:///schema#column_0"-value("\"3\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "csv:///data/rowf1f836cb4ea6efb2a0b1b99f41ad8b103eff4b59"-"csv:///schema#column_1"-value("\"4\"^^'http://www.w3.org/2001/XMLSchema#string'"),
...
test(csv_prefixes,[cleanup(clean), setup(createng)]) :-
    ...
    Triples = [
        ...
        "that/ColumnObject_csv_header"-"this#column_name"-value("\"header\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "that/ColumnObject_csv_header"-"this#index"-value("1^^'http://www.w3.org/2001/XMLSchema#integer'"),
        "that/ColumnObject_csv_some"-"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"-node("this#Column"),
        "that/ColumnObject_csv_some"-"this#column_name"-value("\"some\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "that/ColumnObject_csv_some"-"this#index"-value("0^^'http://www.w3.org/2001/XMLSchema#integer'"),
        ...
        "that/csv"-"this#column"-node("that/ColumnObject_csv_header"),
        "that/csv"-"this#column"-node("that/ColumnObject_csv_some"),
        ...
        "that/row7b52009b64fd0a2a49e6d8a939753077792b0554"-"this#column_header"-value("\"2\"^^'http://www.w3.org/2001/XMLSchema#string'"),
        "that/row7b52009b64fd0a2a49e6d8a939753077792b0554"-"this#column_some"-value("\"1\"^^'http://www.w3.org/2001/XMLSchema#string'")
    ].
